 ...
 */
export function useDataQuery<TQueryFnData = unknown, TError = Error, TData = TQueryFnData>(
 ...
 * This abstracts the library dependency while maintaining full type safety.
 */
export function useDataMutation<TData = unknown, TError = Error, TVariables = void, TContext = unknown>(
